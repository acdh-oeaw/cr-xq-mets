    ...
    <xsl:template match="/mets:mets">
        ...
        <cmd:CMD xmlns:dcr="http://www.isocat.org/ns/dcr" xmlns:cmd="http://www.clarin.eu/cmd/"
            ...
            <cmd:Header>
                <cmd:MdCreator>
                    <xsl:value-of
                        select="mets:metsHdr/mets:agent[@ROLE = 'CREATOR' and @ROLE != 'OTHER'][1]/mets:name"
                    />
                </cmd:MdCreator>
                <cmd:MdCreationDate>
            ...
            <cmd:Resources>
                <cmd:ResourceProxyList>
                    <cmd:ResourceProxy id="dict-gate">
                        ...
                        <cmd:ResourceRef>http://clarin.aac.ac.at/cr/<xsl:value-of
                                select="$project-pid"/>/</cmd:ResourceRef>
                    </cmd:ResourceProxy>
            ...
            <cmd:Components>
                <cmd:collection>
                    <cmd:CollectionInfo ComponentId="clarin.eu:cr1:c_1345561703619">
                        ...
                        <cmd:Modality ComponentId="clarin.eu:cr1:c_1271859438127">
                            ...
                            <cmd:Description ComponentId="clarin.eu:cr1:c_1271859438118">
                                <cmd:Description LanguageID="arz" xml:lang="en-US">various arabic
                                    dialects</cmd:Description>
                            </cmd:Description>
                        </cmd:Modality>
                        <cmd:TimeCoverage>
                        ...
                        <cmd:Description>
                            <cmd:Description xml:lang="en-GB"> Dictionary Gate is a growing
                                collection of lexical resources </cmd:Description>
                        </cmd:Description>
                    </cmd:CollectionInfo>
                    ...
                    <cmd:Contact ComponentId="clarin.eu:cr1:c_1271859438113">
                        ...
                        <cmd:Organisation>Insitute for CorpusLinguistics and
                            TextTechnology</cmd:Organisation>
                    ...
                    <cmd:WebReference ComponentId="clarin.eu:cr1:c_1316422391221">
                        ...
                        <cmd:Description xml:lang="en-US"> a simple search interface to the
                            dictionaries in the dict-gate </cmd:Description>
                    </cmd:WebReference>
                </cmd:collection>
            </cmd:Components>
        </cmd:CMD>
