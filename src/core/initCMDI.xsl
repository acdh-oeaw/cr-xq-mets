...
<xsl:stylesheet xmlns="http://www.loc.gov/METS/" xmlns:ann="http://www.clarin.eu"
                xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:rts="http://cosimo.stanford.edu/sdr/metsrights/"
                xmlns:mods="http://www.loc.gov/mods/v3" xmlns:dcr="http://www.isocat.org/ns/dcr"
                xmlns:mets="http://www.loc.gov/METS/" xmlns:cmd="http://www.clarin.eu/cmd/"
                ...
                <xd:doc scope="stylesheet">
                                <xd:desc>
                                                ...
                                                <xd:p/>
                                                <xd:p>Initializes the initials CMDI record for a
                                                  cr_xq object by placing appropriate values into
                                                  the template which is passed as the input
                                                  document.</xd:p>
                                </xd:desc>
                </xd:doc>
                ...
                <xsl:template
                                match="cmd:ResourceProxy[cmd:ResourceType = 'LandingPage']/cmd:ResourceRef">
                                <xsl:copy>
                                                <xsl:copy-of select="@*"/>
