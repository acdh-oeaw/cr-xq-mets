...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:exist="http://exist.sourceforge.net/NS/exist"
    xmlns:xf="http://www.w3.org/2002/xforms" xmlns:sade="http://bbaw.de/sade" version="2.0">
    <xsl:param name="lang"/>
    <xsl:param name="id"/>
    ...
    <xsl:template match="/">
        <xsl:if test="$id = 'general'">
            ...
            <xf:input ref="instance('sade_config')/sade:meta/sade:project_name" id="projectname"
                incremental="true">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:meta/sade:project_name/sade:title"/>
                <xf:hint
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:meta/sade:project_name/sade:hint"/>
                <xf:alert
            ...
            <xf:select appearance="full" ref="/sade:SADE_project/sade:meta/sade:default_project">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:meta/sade:default_project/sade:title"/>
                <xf:hint
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:meta/sade:default_project/sade:hint"/>
                <xf:item>
                    <xf:label/>
            ...
            <xf:textarea ref="/sade:SADE_project/sade:meta/sade:description" id="descr">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:meta/sade:description/sade:title"/>
                <xf:hint
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:meta/sade:description/sade:hint"
                />
            </xf:textarea>
        </xsl:if>
        <xsl:if test="$id = 'design'">
            ...
            <xf:select1 appearance="minimal" ref="/sade:SADE_project/sade:design/sade:theme">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:theme/sade:title"/>
            ...
            <xf:select appearance="full" ref="/sade:SADE_project/sade:design/sade:fluid">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:fluid/sade:title"/>
                <xf:hint
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:fluid/sade:hint"/>
                <xf:item>
                    <xf:label/>
                    <xf:value>true</xf:value>
                </xf:item>
            ...
            <xf:textarea ref="/sade:SADE_project/sade:design/sade:css" id="css">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:css/sade:title"/>
                <xf:hint
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:css/sade:hint"/>
            </xf:textarea>
            <h2>Footer</h2>
            ...
            <xf:output
                value="/sade:SADE_project/sade:design/sade:footer/sade:img/replace(., '%5C', '/')">
                <xf:label>URL:</xf:label>
            </xf:output>
            <xf:output class="image"
                value="/sade:SADE_project/sade:design/sade:footer/sade:img/replace(., '%5C', '/')"
                mediatype="image/*">
            ...
            <xf:input ref="/sade:SADE_project/sade:design/sade:footer/sade:url">
                <xf:label
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:footer/sade:url/sade:title"/>
                <xf:hint
                    ref="instance('lang')/sade:lang[@id='{$lang}']/sade:design/sade:footer/sade:url/sade:hint"
                />
            </xf:input>
        </xsl:if>
        ...
        <xsl:if test="$id = 'edition' or $id = 'pages'">
            ...
            <xf:trigger id="insert" ref="instance('sade_config')//sade:content[last() &lt; 4]">
                ...
                <xf:action ev:event="DOMActivate">
                    <xf:insert nodeset="/sade:SADE_project/sade:page/sade:content" position="after"
                        at="last()"/>
                    <xf:setvalue ref="/sade:SADE_project/sade:page/sade:content[last()]/sade:column"
                        value="''"/>
                    <xf:setvalue ref="/sade:SADE_project/sade:page/sade:content[last()]/sade:title"
                        value="''"/>
                    <xf:setvalue ref="/sade:SADE_project/sade:page/sade:content[last()]/sade:url"
                        value="''"/>
            ...
            <xf:trigger ref="instance('sade_config')//sade:content[last() &gt; 1]">
                ...
                <xf:delete nodeset="/sade:SADE_project/sade:page/sade:content" at="current()"
