...
//        });
        ...
        it("should be a single element of class virtual-keyboard", function() {
            expect(VirtualKeyboard.virtualKeyboardProto).toExist();
            expect(VirtualKeyboard.virtualKeyboardProto.length).toEqual(1);
            ...
            expect(VirtualKeyboard.virtualKeyboardProto).toHaveAttr('class', 'virtual-keyboard');
            expect(VirtualKeyboard.virtualKeyboardProto).not.toHaveAttr('id');
        });
    });
...
//            console.log(JSON.stringify(VirtualKeyboard.keys));
    ...
    simpleFixtureSetup = function() {
        loadFixtures("virtual-keyboard-input.html");
    };
