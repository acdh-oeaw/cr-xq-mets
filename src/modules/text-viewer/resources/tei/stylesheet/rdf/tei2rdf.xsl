...
<XSL:stylesheet xmlns:XSL="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <XSL:template name="typology">
        ...
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            ...
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">contains an absolute or relative
                place name. </label>
        ...
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            ...
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">(bloc) contains the name of a
                geo-political unit consisting of two or more nation states or countries.</label>
            <P127_has_broader_term rdf:resource="http://www.tei-c.org/type/place"/>
        </E55_Type>
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            rdf:about="http://www.tei-c.org/type/place/country">
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">(country) contains the name of a
                geo-political unit, such as a nation, country, colony, or commonwealth, larger than
                or administratively superior to a region and smaller than a bloc.</label>
            <P127_has_broader_term rdf:resource="http://www.tei-c.org/type/place"/>
        </E55_Type>
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            rdf:about="http://www.tei-c.org/type/place/region">
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">contains the name of an
                administrative unit such as a state, province, or county, larger than a settlement,
                but smaller than a country.</label>
            <P127_has_broader_term rdf:resource="http://www.tei-c.org/type/place"/>
        </E55_Type>
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            rdf:about="http://www.tei-c.org/type/place/district">
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">contains the name of any kind of
                subdivision of a settlement, such as a parish, ward, or other administrative or
        ...
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            ...
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">contains the name of a settlement
                such as a city, town, or village identified as a single geo-political or
        ...
        <E55_Type xmlns="http://purl.org/NET/crm-owl#"
            ...
            <label xmlns="http://www.w3.org/2000/01/rdf-schema#">(geographical name) a name
                associated with some geographical feature such as Windrush Valley or Mount
                Sinai.</label>
            <P127_has_broader_term rdf:resource="http://www.tei-c.org/type/place"/>
        </E55_Type>
    </XSL:template>
